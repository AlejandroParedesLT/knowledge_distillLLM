...
TEACHER_CKPT="${BASE_PATH}/results/gpt2/train/sft/gpt2-xlarge-SFT/e10-bs2-lr5e-05-G1-N4-NN1/10000"
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2/train/kd/${CKPT_NAME}-to-${TEACHER_CKPT_NAME}/"
# seed
SEED=10
