...
#CKPT="${BASE_PATH}/results/gpt2/train/sft/gpt2-xlarge/e10-bs2-lr5e-05-G1-N4-NN1/2000"
CKPT="${BASE_PATH}/results/gpt2/train/sft/gpt2-large/5000"
# data
DATA_DIR="${BASE_PATH}/processed_data/bugnet_python/full/gpt2/"
# hp
EVAL_BATCH_SIZE=16
# runtime
