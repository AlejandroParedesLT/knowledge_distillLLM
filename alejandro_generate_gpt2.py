...
#####################
# TEacher Model
teacher_model_directory = './results/gpt2/train/sft/gpt2-xlarge-SFT/e10-bs2-lr5e-05-G1-N4-NN1/10000'
...
#######################
# Student model SFT
base_sft_model_directory = './results/gpt2/train/sft/gpt2-base-pytorrent/e10-bs4-lr0.0005-G1-N4-NN1/8000'
...
config_sft = AutoConfig.from_pretrained(base_sft_model_directory)
model_sft = AutoModelForCausalLM.from_pretrained(base_sft_model_directory, config=config_sft).to(device)

# ./results/qwen2.5/train/sft/qwen2.5-0.5B-Instruct/e10-bs1-lr1e-05-G2-N2-NN1/8000

###################
# Student Model
student_model_directory = './results/gpt2/train/kd/gpt2-base-to-xlarge-sft/e10-bs8-lr0.0001-G1-N4-NN1-kd0.5/8000'
...
for i in range(1):
    ...
    inputs = base_tokenizer(prompt, return_tensors="pt", padding=True).to(device)
    ...
    with torch.no_grad():
        ...
        with open("responses_gpt2.txt", "a") as f:
