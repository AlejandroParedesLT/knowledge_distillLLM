...
srun bash -c "source \$HOME/final_project_distillLLM/minillm/.env && source \$VENV_DIR/bin/activate && huggingface-cli login --token \$HF_TOKEN && bash scripts/qwen2.5/sft/sft_0.5B.sh"
